    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                String usernameFromPref = mPreferences.getString("username", null);
                String passwordFromPref = mPreferences.getString("password", null);
                if (username.equals(usernameFromPref) && password.equals(passwordFromPref)) {
